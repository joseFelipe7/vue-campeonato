    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content modal-content-custom">
        ...
        <div class="modal-body m-0">
          <div class="moodal-body-container">
            <div class="mb-3">
              ...
              <input type="text" v-model="form.name" class="form-control" aria-label="Username"
                aria-describedby="basic-addon1">
            </div>
            <div class="mb-3">
              <label class="label-input">E-mail</label>
              <input type="text" v-model="form.email" class="form-control" aria-label="Username"
                aria-describedby="basic-addon1">
            </div>
            <div class="mb-3">
              <label class="label-input">Senha</label>
              <input type="password" v-model="form.password" class="form-control" aria-label="Username"
                aria-describedby="basic-addon1">
            </div>
            <div class="mb-3 text-center">
              <button class="btn-confirm-modal" @click="submit">CADASTRE-SE</button>
              <button type="button" class="btn btn-secondary" id="modal-register-close" style="display: none;"
        ...
        <div class="modal-footer modal-footer-custom mb-3 p-0">
          <div>
            <small style="color: #FFF;">Já possui cadastro? <a
                style="text-decoration: none;color: #FE3EE0; cursor: pointer;" data-bs-target="#login-modal"
                data-bs-toggle="modal" data-bs-dismiss="modal">Acesse</a></small>
          </div>
        </div>
      </div>
    </div>
